    ...
    <div class="top">
        <div class="main">
            <div class="currentplaying">
                ...
                <!-- <p class="heading">最近在听</p> -->
            </div>
            <div class="loader" @click="openURL()" v-for="item,index in musicList" :key="index">
                <div class="song">
...
export default {
    ...
    methods: {
        openURL(){
            window.open("https://music.douyin.com/qishui/share/playlist?playlist_id=7146438153074802688&sharer_id=77162577610&sec_sharer_id=MS4wLjABAAAA-XHf1bm4eLyMDfa8pzXP2yiwLVBDbBdfq0eEe2G62FI&hybrid_sdk_version=bullet&auto_play_bgm=1", "_blank");
        }
    },
    async mounted(){
        this.musicList = await getMusicListData()
    }
}
</script>
